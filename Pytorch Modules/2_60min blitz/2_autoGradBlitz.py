...
prediction = model(data) # forward pass, means running through the input data through the model through each of its layers to make a prediction, this is called the forward pass
